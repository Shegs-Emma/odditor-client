      ...
      <div className="flex w-[80%]">
        <div className="w-full flex justify-between">
          ...
          <div className="flex w-[20%] justify-end">
            <div className="items-center justify-center flex border rounded-sm border-[#a82d28] w-[82px] py-2">
              <p className="font-semibold text-xs text-[#a82d28]">Register</p>
            </div>
            <div className="items-center justify-center flex border rounded-sm border-[#a82d28] bg-[#a82d28] w-[82px] py-2 ml-4">
