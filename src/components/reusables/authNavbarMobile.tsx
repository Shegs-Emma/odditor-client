...
const AuthNavbarMobile: FC<sidebarProps> = ({ viewing }) => {
  ...
  return (
    <div className="w-full flex md:hidden h-[70px] shadow-md pt-4 bg-[#BD0A0A] p-4">
      ...
      {isShowing && (
        <div className="fixed top-0 left-0 z-50 w-[327px] h-screen bg-[#BD0A0A] flex flex-col">
          {/* Header */}
          ...
          <div className="flex flex-col h-screen justify-between">
            ...
            <div className="px-4 py-6">
              ...
              <p className="font-bold text-base text-white my-2">
                Privacy Policy
              </p>
              <p className="font-normal text-base text-[#D4D4D4] mt-4">
